...
import { SupabaseOAuthController } from './auth/supabase.js'
import { useBabaSidebarView } from './webview/sidebar.js'
import { registerDevelopmentAutoReload } from './ui/auto-reload.js'
import { disposeAllBm25Runtimes } from './bm25/runtime.js'
