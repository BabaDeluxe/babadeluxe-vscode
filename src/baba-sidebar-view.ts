...
import { WebviewAuthController } from './webview-auth-controller.js'
import type { SupabaseOAuthController } from './supabase-oauth-controller.js'
import { SidebarWebviewNotReadyError } from './errors.js'
import { createContextRootState } from './context-root-state.js'
import { isRecord, isWebviewMessage } from './type-guards.js'
...
export function useBabaSidebarView(parameters: {
  ...
  const commonApi = useWebviewCommon(parameters.context, contextRootState.effectiveRootFsPath)
