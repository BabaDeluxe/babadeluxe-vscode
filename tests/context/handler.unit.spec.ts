...
import { AutoContextHandler } from '../../src/context/handler.js'
import { RgContextBuilder } from '../../src/context/builder.js'
...
vi.mock('../../src/scoring/recent.js', () => ({
  useRecentFiles: vi.fn().mockReturnValue({ value: [] }),
}))

vi.mock('../../src/scoring/context.js', () => ({
